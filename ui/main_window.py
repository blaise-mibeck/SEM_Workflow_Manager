...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _create_menu_bar(self):
        ...
        refresh_action.triggered.connect(self._refresh_collections)
    ...
    # In _connect_signals method of MainWindow class:
    ...
    # Also update the _on_collection_selected method to use options:
    ...
    # Updated method to handle options parameter:
    ...
    def _on_export_requested(self, grid_image, collection):
        ...
        try:
            image_path, caption_path = current_workflow.export_grid(grid_image, collection)
